...
iniciaPopulacao(struct cidade populacao[TAMPOPULACAO][TAMCROMOSSOMO],
			struct cidade *capitais){
...
void fazAvaliacoes(struct cidade populacao[TAMPOPULACAO][TAMCROMOSSOMO],
				float *avaliacoes){
	for(int i=0;i<TAMPOPULACAO;i++)
